...
%b1 is 2.9667 uT 
%pulse duration is 5.7088 ms
%The accompanying slice selection gradient is 5.7088ms long as its plateau 
%at a strength of 0.9519 mT/m. The whole gradient including trapezoidal ends is 7.8088ms.
...
ppoints=101;		% Number of points in the pulse MUST match size of RF and gradient file


grad=2.67522209e8*0.9519e-3/2/pi/100.		% Gradient scaling in Hz/m  405.3 Hz/cm
swid=5;				% Width of sample in cm
b1scale=(2.9667e-6*2.67522209e8/2/pi)		% B1 scaling strength (Hz) 126 Hz

pw=5.7088e-3;			% Pulse width (s)
